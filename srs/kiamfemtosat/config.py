class Variables:
    def __init__(self):
        ...
        self.GAIN_MODEL_C = ['isotropic', '1 antenna', '2 antennas', '3 antennas', 'ellipsoid'][2]
        ...
        # self.KALMAN_COEF = {'q': [1e-6, 1e-10], 'p': [1e-6, 1e-6]*2, 'r': 1e-1}
        self.KALMAN_COEF = {'q': [1e-6]*2, 'p': [1e-6]*4, 'r': 1e-1}
