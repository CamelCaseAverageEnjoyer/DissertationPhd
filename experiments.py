...
def params_search(method_navigation: str = 'kalman_filter rv', t_integrate: float = 1e4, dt: float = 10.,
                  aero: bool = False,):
    min_discrepancy = 1e10
    count = 0
    best_params = []
    d_list = [1e-10, 1e-8, 1e-7, 1e-6, 1e-5, 1e-4]
    q_list = [1e-10, 1e-8, 1e-7, 1e-6, 1e-5, 1e-4]
    r_list = [1e-10, 1e-8, 1e-7, 1e-6, 1e-5, 1e-4]
    p1_list = [1e-10]  # [1e-12, 1e-10, 1e-8]
    p2_list = [1e-10]  # [1e-12, 1e-10, 1e-8]
    # p3_list = [1e-10, 1e-8]
                    ...
                    for p2 in p2_list:
                        ...
                        for _ in range(5):
                            o = Objects(n_c=1, n_f=1,
                                        kalman_coef=[[d, q, p1, p2, p2, r], ['d', 'q', 'p1', 'p2', 'p3', 'r']],
